package be.kdg.programming3.pillgate.repo;//package be.kdg.programming3.repository;
//
...
//
//        userRepository.findAllCareGivers().clear();
//        userRepository.findAllCustomers().clear();
//        userRepository.findAllDashboards().clear();
//        userRepository.findAllMedSchedules().clear();
//
//
//         // to implement later
//
...
//            userRepository.findAllCustomers().addAll(customers);
